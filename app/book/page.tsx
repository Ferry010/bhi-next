...
export default function BookPage() {
  return (
    <>
      ...
      <main>
        <section className="bg-secondary pt-28 md:pt-36 pb-12 overflow-hidden">
          <div className="container max-w-5xl">
            <Breadcrumb items={[{ label: "The Book" }]} variant="light" />
            <div className="grid md:grid-cols-[1.4fr_1fr] gap-10 md:gap-14 items-center mt-2">
              <div>
              ...
              <div className="flex justify-center md:justify-end">
                <img
                  ...
                  alt="Cover of Brand Humanizing by Ferry Hoes and Jonathan Flores"
                  className="w-48 md:w-60 h-auto rounded-md shadow-2xl rotate-2 transition-transform duration-300 hover:rotate-0 hover:scale-105"
                />
              </div>
            </div>
          </div>
