...
const data = {
  ...
  agenda: [
    { time: "Day 1 · 09:00", activity: "Walk-in, then leadership alignment: the strategic case for Brand Humanizing" },
    { time: "Day 1 · 12:30", activity: "Lunch" },
    { time: "Day 1 · 13:30", activity: "Framework deep-dive and organisational mapping" },
    { time: "Day 2 · 09:00", activity: "Skills inventory across departments and levels" },
    { time: "Day 2 · 12:30", activity: "Lunch" },
    { time: "Day 2 · 13:30", activity: "Internal champion selection and capability design" },
    { time: "Day 3 · 09:00", activity: "Strategy building: the 12–36 month roadmap" },
    { time: "Day 3 · 12:30", activity: "Lunch" },
    { time: "Day 3 · 13:30", activity: "Commitment session: decisions, owners, milestones" },
  ],
  leaveWith: [
