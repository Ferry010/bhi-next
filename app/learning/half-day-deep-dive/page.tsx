...
const data = {
  ...
  agenda: [
    ...
    { time: "09:15", activity: "Framing the theme against your reality" },
    { time: "09:45", activity: "The Brand Humanizing lens on this theme" },
    { time: "10:30", activity: "Workshop: your team's own cases, worked through live" },
    { time: "11:30", activity: "Coffee break" },
    { time: "11:45", activity: "From insight to what changes on Monday" },
    { time: "12:30", activity: "Commitments and open discussion" },
    { time: "13:00", activity: "Close" },
  ],
  leaveWith: [
