...
const data: FullServicePageData = {
  ...
  faqs: [
    ...
    { q: "Can you work with organisations outside the Netherlands?", a: "Yes. We've worked across the globe. Remote delivery is available for the right engagements. Travel costs for in-person elements outside Rotterdam are billed at cost." },
  ],
