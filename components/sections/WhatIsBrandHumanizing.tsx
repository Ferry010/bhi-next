        ...
        <div className={`grid lg:grid-cols-2 gap-8 lg:gap-12 items-center transition-all duration-700 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          ...
          <div className={`relative flex items-center justify-center transition-all duration-1000 delay-300 ${isVisible ? "opacity-100 scale-100" : "opacity-0 scale-90"}`}>
            <svg viewBox="0 0 520 500" className="w-72 h-72 md:w-[420px] md:h-[400px]" xmlns="http://www.w3.org/2000/svg">
              <g>
                <circle cx="250" cy="175" r="115" fill="hsl(44 100% 55% / 0.6)" className={`transition-all duration-700 delay-500 ${isVisible ? 'opacity-100' : 'opacity-0'}`} />
                <circle cx="175" cy="275" r="115" fill="hsl(210 85% 58% / 0.52)" className={`transition-all duration-700 delay-700 ${isVisible ? 'opacity-100' : 'opacity-0'}`} />
                <circle cx="325" cy="275" r="115" fill="hsl(217 52% 40% / 0.44)" className={`transition-all duration-700 delay-900 ${isVisible ? 'opacity-100' : 'opacity-0'}`} />
                <circle cx="250" cy="345" r="115" fill="hsl(3 74% 57% / 0.5)" className={`transition-all duration-700 delay-[1100ms] ${isVisible ? 'opacity-100' : 'opacity-0'}`} />
              </g>
              <text x="250" y="125" textAnchor="middle" fill="hsl(216 62% 24%)" stroke="white" strokeWidth="3" paintOrder="stroke" fontSize="12" fontWeight="700" fontFamily="Plus Jakarta Sans, sans-serif">
                <tspan x="250" dy="0">Creativity &amp;</tspan>
                <tspan x="250" dy="15">Organizational Awareness</tspan>
              </text>
              <text x="138" y="255" textAnchor="middle" fill="hsl(216 62% 24%)" stroke="white" strokeWidth="3" paintOrder="stroke" fontSize="12" fontWeight="700" fontFamily="Plus Jakarta Sans, sans-serif">
                <tspan x="138" dy="0">Human Sciences</tspan>
                <tspan x="138" dy="15">&amp; Research</tspan>
              </text>
              <text x="362" y="255" textAnchor="middle" fill="hsl(216 62% 24%)" stroke="white" strokeWidth="3" paintOrder="stroke" fontSize="12" fontWeight="700" fontFamily="Plus Jakarta Sans, sans-serif">
                <tspan x="362" dy="0">Programming,</tspan>
                <tspan x="362" dy="15">Automation &amp; AI</tspan>
              </text>
              <text x="250" y="400" textAnchor="middle" fill="hsl(216 62% 24%)" stroke="white" strokeWidth="3" paintOrder="stroke" fontSize="12" fontWeight="700" fontFamily="Plus Jakarta Sans, sans-serif">
                <tspan x="250" dy="0">Emotional Intelligence</tspan>
                <tspan x="250" dy="15">&amp; Ethics</tspan>
              </text>
              <path d="M250,248 C250,236 240,226 228,226 C214,226 210,240 210,240 C210,258 250,278 250,278 C250,278 290,258 290,240 C290,240 286,226 272,226 C260,226 250,236 250,248 Z" fill="hsl(3 74% 50%)" stroke="white" strokeWidth="2" />
