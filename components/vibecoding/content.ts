...
export const en: VibeContent = {
  ...
  agenda: {
    ...
    items: [
      ...
      { time: "09:45", label: "Brainstorm per group: what will you build?" },
      { time: "10:15", label: "Coffee break" },
      { time: "10:30", label: "Build your tool" },
      { time: "11:30", label: "Final demos" },
      { time: "12:00", label: "Wrap-up" },
    ],
  },
  where: {
...
export const nl: VibeContent = {
  ...
  agenda: {
    ...
    items: [
      ...
      { time: "09:45", label: "Brainstormen per groep: wat gaan jullie bouwen?" },
      { time: "10:15", label: "Koffiepauze" },
      { time: "10:30", label: "Bouwen van je tool" },
      { time: "11:30", label: "Eindpresentaties" },
      { time: "12:00", label: "Afronding" },
    ],
  },
  where: {
