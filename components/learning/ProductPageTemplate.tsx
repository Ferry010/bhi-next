          ...
          <Section>
            <div className="grid md:grid-cols-[200px_1fr] gap-8 md:gap-12 items-center">
              ...
              <div>
                ...
                <p className="text-sunny font-heading font-semibold">{FACILITATOR.closingLine}</p>
              </div>
            </div>
          </Section>
        </div>
        ...
        <div className="container max-w-3xl">
          <Section>
            <div className="bg-navy-card rounded-3xl p-8 md:p-12 shadow-xl border border-accent/10 text-center">
              ...
              {DISPLAY_PRICES && (
                <p className="text-3xl md:text-4xl text-sunny font-heading font-bold mb-4">{shortPrice}</p>
              )}
              ...
              {data.includesBook && (
                <div className="flex items-center justify-center gap-2 mt-6 text-white/70">
                  <BookOpen className="w-4 h-4 text-sunny" />
              ...
              <p className="text-white/40 text-xs mt-5">A free 30-minute call with a Brand Humanizer. An actual human, no sales script.</p>
            </div>
          </Section>
        </div>
      </section>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  {data.crossSells.map((cs, i) => (
                    <div key={i} className="animate-fade-in" style={{ animationDelay: `${i * 120}ms`, animationFillMode: "both" }}>
                      <Link href={cs.to} className="group block bg-navy-card rounded-2xl p-6 border border-transparent hover:border-sunny/40 transition-all duration-300 h-full">
                        <h3 className="font-heading font-bold text-white mb-2 group-hover:text-sunny transition-colors">{cs.label}</h3>
        ...
        <div className="container max-w-3xl text-center relative z-10">
          <Section>
            <p className="text-lg text-white/80">
              Most teams start with one format and go deeper from there. See all the ways to learn:{" "}
              <Link href="/learning" className="text-sunny font-heading font-semibold hover:underline">
